...
$form.addEventListener('submit', (event) => {
    ...
    setTimeout(() => {
        ...
        let message = 'send?phone=' + phone + '&text=%0A*Hola, mi nombre es:*%0A' + name + '%0A*Te contacto desde la siguiente empresa:*%0A' + lastname + '%0A*Me gustaría agendar una entrevista:*%0A' + email + ''
